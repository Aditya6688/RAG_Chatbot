#Removes summary when que asked
...
Please provide a relevant response based on the context above. If the query cannot be answered using the given context, please say so."""
    response = model.generate_content(prompt)
    return response.text
...
if uploaded_file:
    if st.button("Process Audio"):
        # Clear previous chat history when processing a new audio file
        st.session_state.chat_history = []
